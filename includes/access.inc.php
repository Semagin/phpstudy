...
function userIsLoggedIn()
{
  ...
  {
    if (!isset($_POST['login_name']) or $_POST['login_name'] == '' or
      !isset($_POST['passwd']) or $_POST['passwd'] == '')
    {
  ...
  if (isset($_SESSION['login_name']))
  {
    try
    {
      $sql = "SELECT COUNT(*) FROM author
          ...
          WHERE login_name = :login_name AND role.id = :roleId";
      $s = $pdo->prepare($sql);
      $s->bindValue(':login_name', $_SESSION['login_name']);
